...
import { validateBibleVerse, BIBLE_ANSWERS, SPECIAL_ANSWERS } from '@/utils/validation';
...
export const Chapter2 = ({ onComplete }: Chapter2Props) => {
  ...
  return (
    <div className="min-h-screen chapter-bg-2 px-4 py-8">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="harbor-crowd absolute top-1/3 right-0 w-4 h-4 bg-muted rounded-full opacity-40" style={{animationDelay: '1s'}}></div>
        <div className="harbor-crowd absolute top-1/2 left-1/4 w-5 h-5 bg-muted rounded-full opacity-50" style={{animationDelay: '2s'}}></div>
        <div className="harbor-crowd absolute bottom-1/3 right-1/4 w-4 h-4 bg-muted rounded-full opacity-45" style={{animationDelay: '0.5s'}}></div>
      </div>
      ...
      <div className="max-w-2xl mx-auto space-y-6 relative z-10">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <QuestionInput
                  ...
                  validator={(answer) => validateBibleVerse(answer, BIBLE_ANSWERS.chapter2_1)}
                />
              </div>
            </div>
          </div>
        ...
        {step === 'math' && (
          <div className="bg-card/80 backdrop-blur-sm border border-border rounded-lg p-6">
            <div className="space-y-6">
              <div>
                <h3 className="font-cinzel font-semibold text-lg mb-4 text-center">배의 위치는 어디에?</h3>
                ...
                <QuestionInput
                  ...
                  validator={(answer) => answer.trim() === SPECIAL_ANSWERS.chapter2_math}
                />
              </div>
            </div>
          </div>
